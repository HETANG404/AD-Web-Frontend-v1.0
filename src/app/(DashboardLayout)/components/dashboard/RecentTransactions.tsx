...
const RecentTransactions = () => {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                // const response = await fetch('http://localhost:8080/api/feedback/getAllFeedbacks');
    ...
    // @ts-ignore
    let dashboardCard = <><DashboardCard title="Recent Feedback">
        <Timeline
        ...
        <Dialog open={openConfirmDialog} onClose={() => setOpenConfirmDialog(false)}>
            ...
            <DialogContent>
                <DialogContentText>Are you sure you want to delete this feedback? This action cannot be
